package tech.study.cml.orderms.service;
...
import tech.study.cml.orderms.entity.OrderItem;
import tech.study.cml.orderms.listener.dto.OrderCreatedEvent;
import tech.study.cml.orderms.repository.OrderRepository;
...
public class OrderService {
    ...
    private static List<OrderItem> getOrderItems(OrderCreatedEvent event) {
        return event.itens()
                .stream()
                .map(a -> new OrderItem(a.produto(), a.quantidade(), a.preco()))
                .toList();
    }
